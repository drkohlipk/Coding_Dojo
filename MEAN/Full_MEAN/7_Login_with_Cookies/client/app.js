const app = angular.module('app', ['ngRoute', 'ngCookies']); //creates a constant variable named app to store the angular module and imports ngRoute

app.config(['$routeProvider', '$cookiesProvider', function($routeProvider,
	$cookiesProvider) { //routes for angular...
	$routeProvider
